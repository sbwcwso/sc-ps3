...
public interface ExpressionListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ExpressionParser#configuration}.
	 * @param ctx the parse tree
	 */
	void enterConfiguration(ExpressionParser.ConfigurationContext ctx);
	/**
	 * Exit a parse tree produced by {@link ExpressionParser#configuration}.
	 * @param ctx the parse tree
	 */
	void exitConfiguration(ExpressionParser.ConfigurationContext ctx);
}